 ...
 * 一行最多几个点。
 *
 * 格子内宽 47.2px（iPhone 14 / 390px 屏）：5 个点占 5×7 + 4×2 = 43px，放得下
 * 且不挤；6 个就要 52px，直接溢出。点的直径见 app.css 的 --pip。
 */
 ...
 * 两行最多显示 8 个点（5 + 3）。
 *
 * 不是 10（5 + 5）：有溢出时第二行末尾要放 `+N`，而 4 个点加文字宽 55.2px，
 * 比 47.2px 的格子溢出 8px。第二行退到 3 个点加文字是 46.2px，余 1px 放得下。
 *
